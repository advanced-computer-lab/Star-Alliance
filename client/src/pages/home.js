  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      ...
      <div className="border d-flex align-items-center justify-content-center">
        <div>
          <Card
            style={{ width: "18rem", marginLeft: "1cm", marginRight: "1cm" }}
          >
            <Card.Img
              variant="top"
              style={{ height: "5cm" }}
              src="https://images.unsplash.com/photo-1523837157348-ffbdaccfc7de?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDN8fGNyZWF0ZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
            />
            <Card.Body>
              <Card.Title>Create Flight</Card.Title>
              <Card.Text>creating new flights</Card.Text>
              <Button
                style={{ width: "7cm" }}
                href="/createFlight"
        ...
        <div>
          ...
          >
            <Card.Img
              variant="top"
              style={{ height: "5cm" }}
              src="https://media.istockphoto.com/photos/business-concept-male-finger-pointing-delete-key-picture-id464515667?b=1&k=20&m=464515667&s=170667a&w=0&h=ZOliRecXTJeqdKBngcEHcGxz7JIuZYiPnyUoq0ujh18="
            />
            <Card.Body>
              <Card.Title>Delete Flight</Card.Title>
              <Card.Text>Deleting existing flights</Card.Text>
              <Button
                style={{ width: "7cm" }}
                href="/deleteFlight"
                variant="outline-primary"
        ...
        <div>
          ...
          >
            ...
            <Card.Body>
              ...
              <Button style={{ width: "7cm" }} variant="outline-primary">
                More
              </Button>
            </Card.Body>
          </Card>
        ...
        <div>
          ...
          >
            <Card.Img
              variant="top"
              style={{ height: "5cm" }}
              src="https://media.istockphoto.com/photos/button-on-computer-keyboard-picture-id1146311500?b=1&k=20&m=1146311500&s=170667a&w=0&h=lAmXM845JSpofUXfiwCBURBw74y4PkB4wfJGi9iiONY="
            />
            <Card.Body>
              <Card.Title>Update</Card.Title>
              <Card.Text>updating existing flights</Card.Text>
              <Button style={{ width: "7cm" }} variant="outline-primary">
                More
              </Button>
            </Card.Body>
