...
<Row className="mb-3"> 
  ...
  <Row className="mb-3">
  <Form.Group as={Col} className="mb-3" controlId="formGriddepartureAirport">
    <Form.Label>Departure Airport </Form.Label>
    <Form.Control  name="departureAirport" placeholder="Enter Departure Airport" />
  </Form.Group>

  
  <Form.Group as={Col} className="mb-3" controlId="formGridrArivalAirport">
    <Form.Label>Arrival Airport </Form.Label>
    <Form.Control  name="arrivalAirport" placeholder="Enter Arrival Airport" />
  </Form.Group>
  </Row>
  <Row className="mb-3">
  ...
  <Form.Group   as={Col} className="mb-3" controlId="formGridPriceBusiness">
    ...
    <Form.Control  name="businessClassPrice" placeholder="Price for Business Class" />
  </Form.Group>
